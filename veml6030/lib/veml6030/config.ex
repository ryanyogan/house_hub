defmodule Veml6030.Config do
  ...
  # Gains defined by the spec sheet return the hex values
  ...
  # Interruption Time defined by the spec sheet return the hex values
  ...
  defp int_time(:it_default), do: int_time(:it_100_ms)

  # Shutdown controlller enable/disable
  defp shutdown(true), do: 1
  defp shutdown(_), do: 0

  # Interrupt controlller enable/disable
